...
# required script location: the directory containing OBSERVED [see step3.pl], 'patterns' and step5_6.patts files
# run example: ./step5.pl OBSERVED step5_6.patts 
...
foreach $dir (@dirs)
{
open (L, "find $dir -type f -name '$ARGV[0]' |");
while (<L>)
{
chomp;
$file=$_;
